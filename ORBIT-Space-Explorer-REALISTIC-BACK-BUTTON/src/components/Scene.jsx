...
import { RealisticSun } from './RealisticBody';
import RealisticBody from './RealisticBody';
import { Galaxy, GalaxyCore, Nebula, AsteroidField, BlackHole } from './DeepSpace';
...
export default function Scene({ selected, onSelect }) {
  ...
  return (
    <Canvas camera={{ position: [0, 7, 29], fov: 48 }} dpr={[1, 2]}>
      ...
      <RealisticSun data={{...sunData}} onSelect={onSelect} />
